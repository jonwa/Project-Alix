...
public class PlatformWindowButton : MonoBehaviour 
{
	#region PublicMemberVariables
	public enum Action{	None, Show, Hide, ExitToMain };
	...
	//either of the cases will be choosed.
	void OnClick()
	{
		switch (m_Action)
		{
		...
		case Action.Show:
			if(m_Window != null) 
			{
				PlatformWindowHandler.Show(m_Window);
			}
			else
