...
/* Discription: DistanceInspect
 * Class for inspecting at a distance 
 * Based on the Inspect script
 * 
 * Created by: Sebastian: 07-05-14
 * Modified by:  
 */

public class DistanceInspect : ObjectComponent
{
